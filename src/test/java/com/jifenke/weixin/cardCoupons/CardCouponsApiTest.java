...
import com.jifenke.weixin.cardCoupons.request.CreateCardQrCodeRequest;
import com.jifenke.weixin.cardCoupons.wxResponse.*;
import com.jifenke.weixin.jssdk.WxJsApi;
import com.jifenke.weixin.support.WxCardUtils;
...
import static com.jifenke.weixin.support.WxHttpClient.MAPPER;
...
//    }
    ...
    public void testJson2bean() throws IOException {
        ...
        QueryWxSubMerchantResponse respose = MAPPER.readValue(json, QueryWxSubMerchantResponse.class);
    ...
    public void testCardCategory() throws JsonProcessingException {
        ...
        String json = MAPPER.writeValueAsString(cardCategory.getCategories());
        System.err.println(json);
    }
    ...
    public void testQueryWxPoiResponseJson2Bean() throws IOException {
        ...
        QueryWxPoiResponse response = MAPPER.readValue(json, QueryWxPoiResponse.class);
    ...
    public void testWxCardBaseInfoJson() throws IOException {
        ...
        WxCardBaseInfo info = MAPPER.readValue(json, WxCardBaseInfo.class);
    ...
    public void testWxCardGrouponCardInfo() throws IOException {
        ...
        String newJson = MAPPER.writeValueAsString(info.get("card"));
        System.err.println(newJson);
    }
    ...
    public void queryCardStatusTest() throws IOException {
        ...
        JsonNode card = MAPPER.readTree(json).get("card");
