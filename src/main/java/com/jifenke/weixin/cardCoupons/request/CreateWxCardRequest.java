...
import com.jifenke.weixin.cardCoupons.basic.WxCardCodeType;
import com.jifenke.weixin.cardCoupons.basic.WxCardDateType;
import com.jifenke.weixin.cardCoupons.basic.WxCardType;
import com.jifenke.weixin.cardCoupons.basic.WxMerServiceType;
import com.jifenke.weixin.support.ParamsUtils;
...
import static com.jifenke.weixin.cardCoupons.basic.WxCardTypeExtraConstant.*;
...
public class CreateWxCardRequest implements WxRequest {
    ...
    public AbstractWxCardInfo getWxCardInfo() {
        switch (cardType) {
            case GROUPON:
                return new WxGrouponCardInfo(baseInfo, advancedInfo, findParam(extraParams, GROUPON_EXTRA_PARAM, String.class));
            case CASH:
                return new WxCashCardInfo(baseInfo, advancedInfo, findParam(extraParams, CASH_EXTRA_PARAM1, Integer.class),
                        findParam(extraParams, CASH_EXTRA_PARAM2, Integer.class));
            case DISCOUNT:
                return new WxDiscountCardInfo(baseInfo, advancedInfo, findParam(extraParams, DISCOUNT_EXTRA_PARAM, Integer.class));
            case GIFT:
                return new WxGiftCardInfo(baseInfo, advancedInfo, findParam(extraParams, GIFT_EXTRA_PARAM, String.class));
            case GENERAL_COUPON:
                return new WxGeneralCouponCardInfo(baseInfo, advancedInfo, findParam(extraParams, GENERA_COUPON_EXTRA_PARAM, String.class));
            default:
